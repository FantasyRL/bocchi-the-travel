...
func (p *kFollowHandlerClient) TrustAction(ctx context.Context, req *trust.FollowActionRequest, callOptions ...callopt.Option) (r *trust.FollowActionResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.TrustAction(ctx, req)
}

func (p *kFollowHandlerClient) FollowerList(ctx context.Context, req *trust.FollowerListRequest, callOptions ...callopt.Option) (r *trust.FollowerListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.FollowerList(ctx, req)
}

func (p *kFollowHandlerClient) FollowingList(ctx context.Context, req *trust.FollowingListRequest, callOptions ...callopt.Option) (r *trust.FollowingListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.FollowingList(ctx, req)
}

func (p *kFollowHandlerClient) TrustEachList(ctx context.Context, req *trust.FriendListRequest, callOptions ...callopt.Option) (r *trust.FriendListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
